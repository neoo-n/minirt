...
/*   Updated: 2025/06/29 15:53:39 by akabbaj          ###   ########.ch       */
/*                                                                            */
/* ************************************************************************** */

#include "features.h"

void	print_shape_info(t_gen *gen, int i)
{
...
void	print_gen(t_gen *gen)
{
	...
	printf("C %.2f,%.2f,%.2f %.2f,%.2f,%.2f, %.2f\n\n",
		gen->c->coords.x, gen->c->coords.y, gen->c->coords.z,
		gen->c->vector.x, gen->c->vector.y, gen->c->vector.z, gen->c->fov);
	i = 0;
	while (gen->l[i])
	{
