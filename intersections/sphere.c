...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/10 09:56:17 by akabbaj           #+#    #+#             */
/*   Updated: 2025/06/10 09:59:59 by akabbaj          ###   ########.ch       */
/*                                                                            */
/* ************************************************************************** */

#include "intersections.h"

double	check_in_sphere(t_coords ray, t_coords origin, t_shape *sphere, double t)
{
	t_coords	point;
	double		dist;
...
double	sphere_intersect(t_coords ray, t_coords origin, t_shape *sphere)
{
	...
	{
		if ((-b - sqrt(delta)) / 2 >= 0)
			return (check_in_sphere(ray, origin, sphere, (-b - sqrt(delta)) / 2));
